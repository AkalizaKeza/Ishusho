...
import com.akalizakeza.apps.ishusho.models.Person;
...
public class UserDetailActivity extends AppCompatActivity {
    public final static String USER_EXTRA_NAME = "user";
    public final static String USER_ID_EXTRA_NAME = "userid";
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    followUserFab.setImageDrawable(ContextCompat.getDrawable(
                            UserDetailActivity.this, R.drawable.ic_done_black_48dp));
                } else {
                    followUserFab.setImageDrawable(ContextCompat.getDrawable(
                            UserDetailActivity.this, R.drawable.ic_person_follow_black_48dp));
                }
            }
