...
public class ComicSettings extends Dialog implements OnSeekBarChangeListener {
	final int maxPanelCount = 6;
	private int curPanelCount = 3;
	...
	public ComicSettings(Context context, int startPanelCount, boolean startDrawGrid, int ori, String format, View.OnClickListener oklistener) {
		super(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.comic_settings);
